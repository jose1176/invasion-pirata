...
function preload() {
  ...
  background = loadSound("./assets/background_music.pm3");
  waterSound = loadSound("./assets/cannon_water.mp3");
  pirateSound = loadSound("./assets/pirate_laugh.mp3");
  explocion = loadSound("./assets/cannon_explocion.mp3");
}
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
       ...
       if(!isLaughing && !pirateSound.isPlayting()){
        pirateSound.play();
        isLaughing = true;
       }
